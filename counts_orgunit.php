...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <ul class="menu">
            ...
            <li><a class="active" href="counts_orgunit.php">Org Units</a></li>
        ...
        <?php
            ...
            if ($check->select_db($DBname) === TRUE) {
                ...
                $sql = "SELECT orgUnitPath,COUNT(DISTINCT(deviceId)) FROM importdata GROUP BY orgUnitPath ORDER BY orgUnitPath";
