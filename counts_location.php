...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <ul class="menu">
            ...
            <li><a class="active" href="counts_location.php">Location</a></li>            
        </ul>
        <hr>
        ...
        <?php
            ...
            if ($check->select_db($DBname) === TRUE) {
                ...
                $sql = "SELECT annotatedLocation,COUNT(DISTINCT(deviceId)) FROM importdata GROUP BY annotatedLocation ORDER BY annotatedLocation";
